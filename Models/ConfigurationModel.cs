...
namespace SmartStore.WebHooks.Models
{
    public class ConfigurationModel : ModelBase
    {


        [SmartResourceDisplayName("Plugins.SmartStore.WebHooks.MyFirstSetting")]
        [AllowHtml]
        ...
        /// </summary>
        [UIHint("Picture")]
        [SmartResourceDisplayName("Plugins.SmartStore.WebHooks.PictureId")]
        public int PictureId { get; set; }

        /// <summary>
        /// Renders a color picker control onto a string property
        /// </summary>
        [SmartResourceDisplayName("Plugins.SmartStore.WebHooks.Color")]
        [UIHint("Color")]
        ...
        //[Required]
        [AllowHtml]
        [SmartResourceDisplayName("Plugins.SmartStore.WebHooks.Text")]
